...
export const newVideoSection = document.getElementById('newVideoSection');
...
export const skipToStartBtn = document.getElementById('skipToStartBtn');
export const skipToEndBtn = document.getElementById('skipToEndBtn');
export const playbackSpeedSelect = document.getElementById('playbackSpeedSelect');

// 비디오 프로그레스 바 및 시간 표시 요소들
export const videoProgressBar = document.getElementById('videoProgressBar');
export const videoProgressFill = document.getElementById('videoProgressFill');
export const currentTime = document.getElementById('currentTime');
export const totalTime = document.getElementById('totalTime');
export const videoTimeDisplay = document.getElementById('videoTimeDisplay');
...
export const processBtn = document.getElementById('processBtn'); // 호환성을 위해 유지
export const processShortsBtn = document.getElementById('processShortsBtn');
export const processGeneralBtn = document.getElementById('processGeneralBtn');
export const shortsAspectRatio = document.getElementById('shortsAspectRatio');
export const generalAspectRatio = document.getElementById('generalAspectRatio');
...
export const startTranscriptionBtn = document.getElementById('startTranscriptionBtn');
export const modelSelector = document.getElementById('modelSelector');
export const compressionMethodSelector = document.getElementById('compressionMethodSelector');
export const languageSelector = document.getElementById('languageSelector');
export const subtitleContainer = document.getElementById('subtitleContainer');
export const subtitlePlaceholder = document.querySelector('.subtitle-placeholder');
export const transcriptionProgress = document.getElementById('transcriptionProgress');
export const transcriptionProgressFill = document.getElementById('transcriptionProgressFill');
export const transcriptionProgressText = document.getElementById('transcriptionProgressText');
export const transcriptionProgressDetails = document.getElementById('transcriptionProgressDetails');
...
export const testAIBtn = document.getElementById('testAIBtn');
export const apiSettingsBtn = document.getElementById('apiSettingsBtn');

// Google Config Modal
export const googleConfigBtn = document.getElementById('googleConfigBtn');
export const googleConfigModal = document.getElementById('googleConfigModal');
export const googleClientIdInput = document.getElementById('googleClientIdInput');
export const currentGoogleConfigInfo = document.getElementById('currentGoogleConfigInfo');
export const saveGoogleConfigBtn = document.getElementById('saveGoogleConfigBtn');
export const cancelGoogleConfigBtn = document.getElementById('cancelGoogleConfigBtn');
export const resetGoogleConfigBtn = document.getElementById('resetGoogleConfigBtn');
export const closeGoogleConfigModalBtn = document.getElementById('closeGoogleConfigModalBtn');

// Video Analysis Button
export const videoAnalysisBtn = document.getElementById('videoAnalysisBtn');

// Image Upload elements
export const imagePreviewContainer = document.getElementById('imagePreviewContainer');
export const imageUploadBtn = document.getElementById('imageUploadBtn');
export const imageInput = document.getElementById('imageInput');
export const previewImage = document.getElementById('previewImage');
export const imageFileName = document.getElementById('imageFileName');
export const imageFileSize = document.getElementById('imageFileSize');
export const removeImageBtn = document.getElementById('removeImageBtn');

// Image Modal
export const imageModal = document.getElementById('imageModal');
