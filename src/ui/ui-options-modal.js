    ...
    initializeEventListeners() {
        ...
        if (startVideoSplitBtn) {
            startVideoSplitBtn.addEventListener('click', async () => {
                ...
                try {
                    const { splitVideo } = await import('../modules/video-splitter.js');
        ...
        if (clearCacheBtn) {
            clearCacheBtn.addEventListener('click', () => memoryManager.clearAllCache());
        }
    ...
    openModal(category) {
        ...
        if (modal) {
            ...
            if (category === 'prompt') {
                ...
                const currentLimit = memoryManager.getMemoryLimit();
...
function applyPerformanceCacheOptions() {
   const memoryLimit = document.getElementById('memoryLimitSlider').value;
    memoryManager.setMemoryLimit(memoryLimit);
